...
export const createRecipePayloadSchema = registry.register(
    ...
    z.object({
        ...
        categories: z.array(z.number().int().positive()).min(1, "At least one category is required").openapi({ example: [1, 2] }),
...
registry.registerPath({
    ...
    description: "Returns a paginated list of recipes created by the authenticated user with optional status filter.",
    security: [{ BearerAuth: [] }],
    request: { query: getMyRecipesQuerySchema },
    responses: {
        200: jsonResponse(GetRecipesResponseSchema, "Successfully retrieved authenticated user's recipes"),
...
registry.registerPath({
    ...
    description: "Returns a paginated list of all recipes across any moderation status. Requires admin privileges.",
    security: [{ BearerAuth: [] }],
    request: { query: getAdminRecipesQuerySchema },
    responses: {
        200: jsonResponse(GetRecipesResponseSchema, "Successfully retrieved recipes for administration"),
        401: errors.unauthorized,
...
registry.registerPath({
    ...
    description: "Returns full recipe details including categories, ingredients, and ordered instructions.",
...
registry.registerPath({
    ...
    description: "Creates a new recipe with categories, ingredients, and instructions. Requires authentication.",
    security: [{ BearerAuth: [] }],
...
registry.registerPath({
    ...
    description: "Updates an existing recipe including title, description, categories, ingredients, and instructions.",
    security: [{ BearerAuth: [] }],
    request: {
...
registry.registerPath({
    ...
    description: "Deletes a recipe and its associated ingredients, instructions, and categories by ID.",
    security: [{ BearerAuth: [] }],
    request: { params: recipeIdParamSchema },
    responses: {
...
registry.registerPath({
    ...
    description: "Updates the status (pending, approved, rejected) and rejection reason of a recipe. Requires admin privileges.",
    security: [{ BearerAuth: [] }],
    request: {
        params: recipeIdParamSchema,
