      ...
      <div className="flex justify-between items-center max-w-[1200px] mx-auto px-4 md:px-12 py-5">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link
            ...
            className="w-10 h-10 rounded-full bg-[#e9e8e4] overflow-hidden border-2 border-[#e9e8e4] cursor-pointer hover:scale-105 active:scale-95 transition-transform"
          >
            <img
              alt="Ảnh đại diện đầu bếp"
